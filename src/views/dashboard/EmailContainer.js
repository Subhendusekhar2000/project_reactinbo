  ...
  return (
    <div className="w-full flex items-center border-b border-gray-500 h-[60px] px-5">
      <div className="w-full flex justify-between">
        <div className="">
          <h4 className="text-sm">Subhendusekhar Behera</h4>
          <p className="text-[11px]">sekharsubhendu352000@gmail.com</p>
        </div>
...
const LoadDetails = () => {
  const details = [
    ...
    {
      field: "Email Id",
      value: "sekharsubhendu352000@gmail.com",
    },
    {
      field: "LinkedIn",
      value: "sekharsubhendu.linkin.in",
    },
    {
      field: "Company Name",
      value: "ReachInBox",
    ...
    <div className=" bg-dark_theme p-4 rounded-lg border border-gray-500">
      <div className="space-y-2">
        ...
        <div className="text-sm space-y-5 text-gray-300">
          ...
          <p className="">
            lorem inpusm lorem inpusmlorem inpusmlorem inpusm lorem inpusm lorem
            inpusm lorem inpusm lorem inpusm lorem inpusm lorem inpusm lorem
            inpusm lorem inpusm lorem inpusm lorem inpusm lorem inpusm lorem
            inpusm lorem inpusm lorem inpusm lorem inpusm lorem inpusm
          </p>
        </div>
      </div>
    </div>
